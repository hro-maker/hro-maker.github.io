...
/* harmony import */ var _modules_imagesize__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/imagesize */ "./src/js/modules/imagesize.js");
/* harmony import */ var _modules_akordeon__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/akordeon */ "./src/js/modules/akordeon.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'horizon', '.main-prev-btn', '.main-next-btn');
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vertical');
  Object(_modules_imagesize__WEBPACK_IMPORTED_MODULE_3__["default"])('.sizes-block');
  Object(_modules_akordeon__WEBPACK_IMPORTED_MODULE_4__["default"])('.accordion-heading');
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_5__["default"])('.burger-menu', '.burger');
});

/***/ }),

/***/ "./src/js/modules/akordeon.js":
/*!************************************!*\
  !*** ./src/js/modules/akordeon.js ***!
  \************************************/
...
var acordeon = function acordeon(trigerrSelector) {
  var btns = document.querySelectorAll(trigerrSelector);
  btns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      btns.forEach(function (item) {
        if (item !== btn) {
          item.classList.remove('active-style');
          item.nextElementSibling.classList.remove('active_content');
        }
      });
      this.classList.toggle('active-style');
      this.nextElementSibling.classList.toggle('active_content'); // if (this.classList.contains('active-style')) {
...
var filter = function filter() {
  ...
  var Tybefolder = function Tybefolder(marker) {
    markAll.forEach(function (marko) {
      marko.style.display = 'none';
      marko.classList.remove('animated');
      marko.classList.remove('fadeIn');
    });
...
var sizeImage = function sizeImage(imageselector) {
  var blocks = document.querySelectorAll(imageselector);

  function Sowimage(block) {
  ...
  blocks.forEach(function (item) {
    item.addEventListener('mouseover', function () {
      Sowimage(item);
      item.classList.add('animated', 'rotateInDownLeft');
    });
    item.addEventListener('mouseout', function () {
      hideImage(item);
      item.classList.remove('animated', 'rotateInDownLeft');
    });
  });
};
